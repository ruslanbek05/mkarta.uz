<?php /* C:\wamp64\www\mkarta.uz\administrator\components\com_akeeba\ViewTemplates\Browser\default.blade.php */ ?>
<?php
/**
...
?>
<?php $this->addJavascriptInline($script, 'text/javascript'); ?>
    ...
    <div class="akeeba-panel--100 akeeba-panel--primary">
        <div>
            <form action="index.php" method="get" name="adminForm" id="adminForm"
                ...
                <span title="<?php echo \JText::_($this->writable ? 'COM_AKEEBA_CPANEL_LBL_WRITABLE' : 'COM_AKEEBA_CPANEL_LBL_UNWRITABLE'); ?>"
            ...
            <?php if(count($this->subfolders)): ?>
                <table class="akeeba-table akeeba-table--striped">
                    ...
                    <?php foreach($this->subfolders as $subfolder): ?>
                        <tr>
                            <td>
                                <a class="akeeba-browser-folder" href="<?php echo $this->escape(JUri::base()); ?>index.php?option=com_akeeba&view=Browser&tmpl=component&folder=<?php echo $this->escape($this->folder . '/' . $subfolder); ?>"><?php echo $this->escape($subfolder); ?></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </table>
