<?php /* C:\wamp64\www\mkarta.uz\administrator\components\com_akeeba\ViewTemplates\Profiles\default.blade.php */ ?>
<?php
/**
            ...
            <tr>
                ...
                <td>
                    <a class="akeeba-btn akeeba-btn--small akeeba-btn--primary"
                       href="index.php?option=com_akeeba&task=SwitchProfile&profileid=<?php echo (int)$profile->id; ?>&returnurl=<?php echo base64_encode(\Joomla\CMS\Uri\Uri::base() . 'index.php?option=com_akeeba&view=Configuration'); ?>&<?php echo $this->container->platform->getToken(true); ?>=1">
                    ...
                    <a class="akeeba-btn akeeba-btn--small akeeba-btn--dark"
                       href="index.php?option=com_akeeba&view=Profile&task=read&id=<?php echo $profile->id; ?>&basename=<?php echo \Joomla\CMS\Application\ApplicationHelper::stringURLSafe($profile->description); ?>&format=json&<?php echo $this->container->platform->getToken(true); ?>=1">
