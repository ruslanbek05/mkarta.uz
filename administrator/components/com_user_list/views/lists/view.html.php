...
/**
 * View class for a list of User_list.
 *
 * @since  1.6
 */
class User_listViewLists extends \Joomla\CMS\MVC\View\HtmlView
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		User_listHelper::addSubmenu('lists');
	...
	protected function addToolbar()
	{
		...
		$canDo = User_listHelper::getActions();

		JToolBarHelper::title(Text::_('COM_USER_LIST_TITLE_LISTS'), 'lists.png');
		...
		{
			JToolBarHelper::preferences('com_user_list');
		}

		// Set sidebar action - New in 3.0
		JHtmlSidebar::setAction('index.php?option=com_user_list&view=lists');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`avatar`' => JText::_('COM_USER_LIST_LISTS_AVATAR'),
			'a.`username`' => JText::_('COM_USER_LIST_LISTS_USERNAME'),
			'a.`year_of_birth`' => JText::_('COM_USER_LIST_LISTS_YEAR_OF_BIRTH'),
			'a.`gender`' => JText::_('COM_USER_LIST_LISTS_GENDER'),
			'a.`view_health_info`' => JText::_('COM_USER_LIST_LISTS_VIEW_HEALTH_INFO'),
		);
	}
