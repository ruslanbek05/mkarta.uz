 ...
 * @since  1.6
 */
class AnalysisControllerAnalysisForm extends \Joomla\CMS\MVC\Controller\FormController
{
	/**
	...
	public function edit($key = NULL, $urlVar = NULL)
	{
		...
		// Get the model.
		$model = $this->getModel('AnalysisForm', 'AnalysisModel');
	...
	public function save($key = NULL, $urlVar = NULL)
	{
		...
		if ($data === false)
		{
			...
			$app->setUserState('com_analysis.edit.analysis.data', $jform);

			// Redirect back to the edit screen.
			$id = (int) $app->getUserState('com_analysis.edit.analysis.id');
			$this->setRedirect(Route::_('index.php?option=com_analysis&view=analysisform&layout=edit&id=' . $id, false));
		...
		{
			// Save the data in the session.
			$app->setUserState('com_analysis.edit.analysis.data', $data);
	...
	public function cancel($key = NULL)
	{
		...
		$editId = (int) $app->getUserState('com_analysis.edit.analysis.id');
	...
	public function remove()
    {
        ...
        try
        {
            ...
            // Redirect to the list screen
            $this->setMessage(Text::_('COM_ANALYSIS_ITEM_DELETED_SUCCESSFULLY'));
            $this->setRedirect(Route::_($url, false));
        ...
        catch (Exception $e)
        {
            ...
            $this->setRedirect('index.php?option=com_analysis&view=analyzes');
        }
    }
}
